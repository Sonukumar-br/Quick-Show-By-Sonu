...
import { ArrowRightIcon, ClockIcon, Rows } from 'lucide-react'
  ...
  return show ? (
    ...
    md:pt-50'>
     ...
     <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
      ...
      <h1 className='text-2xl font-semibold mb-4'>Selected your seat</h1>
      <img src={assets.screenImage} alt="screen" />
      <p className='text-gray-400 text-sm mb-6'>SCREEN SIDE</p>

      <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
        <div className='grid grid-cols-2 md:grid-cols-1 gap-8 md:gap-2 mb-6'>
          {groupRows[0].map(row => renderSeats(row))}</div>
      </div>
     ...
     items-c gap-1 mt-20 px-10 py-3 text-sm bg-primary 
