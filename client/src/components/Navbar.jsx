  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      >
        ...
        <Link onClick={scrollToTopAndClose} to='/'>Home</Link>
        <Link onClick={scrollToTopAndClose} to='/movies'>Movies</Link>
        <Link onClick={scrollToTopAndClose} to='/'>Theaters</Link>
        <Link onClick={scrollToTopAndClose} to='/'>Releases</Link>
        {favorites?.length > 0 && (
          <Link onClick={scrollToTopAndClose} to='/favorite'>
