...
const MovieCard=({movie}) => {
  ...
  return (
    ...
    <p>{new Date(movie.release_date).getFullYear()} . {movie.genres.slice(0,2).map(genre => genre.name).join(" | ")} . {timeFormat(movie.runtime)}
    ...
    <div className='flex items-center justify-between mt-4 pb-3'>
        ...
        <p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-10'>
